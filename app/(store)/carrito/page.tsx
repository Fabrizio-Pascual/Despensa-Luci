...
import { ArrowLeft, ArrowRight, Minus, Plus, ShoppingBag, Trash2, Package } from 'lucide-react'
          ...
          <>
            <div className="space-y-4">
              {items.map((item) => {
                ...
                return (
                  <div key={item.id} className="flex gap-4 p-4 rounded-[24px] bg-card border border-border/40 premium-transition">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <button
                          className="text-muted-foreground hover:text-destructive premium-transition shrink-0"
                ...
                <div className="grid grid-cols-4 gap-3">
                  {suggestions.map((p) => (
                    <button
                      ...
                      className="group relative aspect-square rounded-2xl overflow-hidden bg-muted border border-border/40 premium-transition hover:border-primary"
